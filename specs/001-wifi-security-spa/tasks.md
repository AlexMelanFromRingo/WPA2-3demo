...
- [X] T052 [P] Светлая центральная колонка по образцу референсов; блок «Вычисление» с реальными значениями на каждом шаге; тёмная тема (переключатель в шапке, глобальный CSS-оверрайд палитры, сохранение выбора в localStorage)
