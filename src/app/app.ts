 ...
 * TOTP_demo / rsa16-edu): белая шапка-карточка, вкладки, сворачиваемая
 * карточка параметров, контент модуля стопкой.
 */
@Component({
  selector: 'app-root',
    ...
    <div class="min-h-screen text-slate-800">
      ...
      <main class="mx-auto max-w-3xl px-4 py-6 sm:px-6">
        <details class="mb-5 rounded-xl border border-slate-200 bg-white shadow-sm" open>
          ...
          >
            ⚙ Параметры сети (общий сценарий для всех модулей)
          </summary>
...
export class App {
  ...
  protected readonly tabs = [
    { path: '/wpa2', label: '1 · WPA2 Handshake' },
    { path: '/wpa3', label: '2 · WPA3 SAE' },
    { path: '/hashcat', label: '3 · Hashcat 22000' },
  ];
